import type { PartialPrettierExtendedOptionsType } from '../types';
...
/** Default prettier rules.(默认 prettier 配置选项) */
export const DEFAULT_PRETTIER_RULES: PartialPrettierExtendedOptionsType = {
  useTabs: false,
  tabWidth: 2,
  printWidth: 100,
  singleQuote: true,
